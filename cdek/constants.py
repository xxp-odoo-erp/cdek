...
INTAKES_URL = 'intakes'
ORDERS_URL = 'orders'
ZIP_CODES_URL = 'location/postalcodes'
...
DELIVERY_POINTS_FILTER = [
    ...
    'weight_max', 'lang', 'take_only', 'is_handout', 'is_reception',
    'size', 'page'
]

CITIES_FILTER = [
    'country_codes', 'region_code', 'kladr_region_code',
    'fias_region_guid', 'kladr_code', 'fias_guid', 'postal_code',
    'code', 'city', 'size', 'page', 'lang'
]
...
ERRORS = {
    ...
    'v2_wrong_interval': 'Передан некорректный промежуток времени',
        ...
        'v2_invoice_entity_empty': 'Квитанция с указанным идентификатором не сформировалась, так как все заказы некорректны',
        'v2_print_form_expired': 'Истек срок хранения печатной формы с указанным идентификатором',
        'v2_print_form_empty': 'Печатная форма с указанным идентификатором не сформировалась, так как все заказы некорректны',
