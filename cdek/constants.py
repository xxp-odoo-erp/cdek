...
ERRORS = {
    ...
    "v2_similar_request_still_processed": "Предыдущий запрос такого же типа над этой же сущностью еще не выполнился",  # noqa: E501
    ...
    "v2_entity_not_found": "Сущность (заказ, заявка и т.д.) с указанным идентификатором не существует либо удалена",  # noqa: E501
    "v2_entity_forbidden": "Сущность (заказ, заявка и т.д.) с указанным идентификатором существует, но принадлежит другому клиенту",  # noqa: E501
    "v2_entity_invalid": "Сущность (заказ, заявка и т.д.) с указанным идентификатором существует, но некорректна",  # noqa: E501
    "v2_order_not_found": "Заказ с указанным номером не существует либо удален",
    "v2_order_forbidden": "Заказ с указанным номером существует, но принадлежит другому клиенту",  # noqa: E501
    "v2_order_number_empty": "Не переданы номер и идентификатор заказа",
    "v2_shipment_address_multivalued": "Одновременно переданы ПВЗ отправителя и адрес отправителя. Необходимо указать 1 параметр",  # noqa: E501
    "v2_delivery_address_multivalued": "Одновременно переданы ПВЗ получателя и адрес получателя. Необходимо указать 1 параметр.",  # noqa: E501
    ...
    "orders_number_is_empty": "Все заказы с указанными номерами и идентификаторами некорректны",  # noqa: E501
    ...
    "v2_entity_not_found_im_number": "Сущность с указанным идентификатором не существует либо удалена",  # noqa: E501
    "v2_order_location_from_and_shipment_point_empty": "Адрес отправителя и ПВЗ отправителя пустые",  # noqa: E501
    "v2_order_location_to_and_delivery_point_empty": "Адрес получателя и ПВЗ получателя пустые",  # noqa: E501
    "v2_number_items_in_package_is_more_126": "Позиций в товаре более 126",
    "v2_package_id_is_empty": "Не передан идентификатор уже существующей упаковки заказа",  # noqa: E501
    "v2_required_param_empty": "Не заполнено обязательное поле",
    "v2_city_can_not_be_changed": "Передан новый город в адресе доставки (для регистрации договоренности)",  # noqa: E501
    ...
    "v2_intake_exists_by_date_address": "На переданную дату и в переданный адрес уже есть заявка",  # noqa: E501
    "v2_webhook_type_incorrect": "Передан некорректный тип события",
    "v2_entity_empty": "Все заказы с указанными номерами и идентификаторами некорректны",  # noqa: E501
    ...
    "v2_invoice_entity_empty": "Квитанция с указанным идентификатором не сформировалась, так как все заказы некорректны",  # noqa: E501
    "v2_print_form_expired": "Истек срок хранения печатной формы с указанным идентификатором",  # noqa: E501
    "v2_print_form_empty": "Печатная форма с указанным идентификатором не сформировалась, так как все заказы некорректны",  # noqa: E501
